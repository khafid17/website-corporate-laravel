...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Nav::isRoute('berita') }}">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('post.index') }}">List Berita</a>
                        <a class="collapse-item" href="{{ route('post.tampil_hapus') }}">List Hapus</a>
                    </div>
                </div>
            </li>
        {{-- </li> --}}
        ...
        <!-- Nav Item - Kategori -->
        <li class="nav-item {{ Nav::isRoute('kategori') }}">
        ...
        <!-- Nav Item - Download -->
        <li class="nav-item {{ Nav::isRoute('download') }}">
